...
import { ArrowLeft, MapPin, Clock, Users, Share2, Heart, CheckCircle, XCircle } from 'lucide-react';
    ...
    >
      ...
      <div className="relative h-56 flex-shrink-0">
        ...
        <button
          ...
          style={{ backgroundColor: 'rgba(13,27,42,0.7)', backdropFilter: 'blur(8px)' }}
          onClick={onBack}
        >
        ...
        {/* Sport icon + title overlay at bottom */}
      ...
      <div className="flex-1 overflow-y-auto pb-32">
        <div className="p-5 space-y-5">
          ...
          <p
            className="text-sm"
            style={{ color: 'rgba(245, 239, 224, 0.6)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}
          >
            📍 {game.courtName}
          </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div
              ...
              style={{ backgroundColor: 'rgba(245, 239, 224, 0.06)', border: '1px solid rgba(245, 239, 224, 0.08)' }}
            >
              <div className="flex items-center gap-2 mb-1">
                <Clock size={14} color={accentColor} />
                <span className="text-xs font-semibold uppercase tracking-wide" style={{ color: accentColor, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  Date & Time
                </span>
              </div>
              ...
              <p className="text-xs" style={{ color: 'rgba(245, 239, 224, 0.6)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                {game.time}
              </p>
            </div>
          ...
          >
            ...
            >
              {game.slotsTotal - game.slotsFilled} slots remaining
            </p>
          </div>
          ...
          <div className="flex gap-3">
            <div
              ...
              style={{ backgroundColor: 'rgba(244, 114, 43, 0.1)', border: '1px solid rgba(244, 114, 43, 0.2)' }}
            >
              <p className="text-xs mb-1" style={{ color: 'rgba(245, 239, 224, 0.5)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Entry Fee
              </p>
              <p
                className="text-xl font-black"
                style={{ color: '#F4722B', fontFamily: "'Bricolage Grotesque', sans-serif" }}
              >
            ...
            <div
              className="flex-1 p-3 rounded-xl text-center"
              style={{
                backgroundColor: game.status === 'OPEN' ? 'rgba(34, 197, 94, 0.1)' : 'rgba(239, 68, 68, 0.1)',
                border: `1px solid ${game.status === 'OPEN' ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)'}`,
              }}
            >
              <p className="text-xs mb-1" style={{ color: 'rgba(245, 239, 224, 0.5)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Status
          ...
          {game.description && (
            <div>
              ...
              <p
                ...
                style={{ color: 'rgba(245, 239, 224, 0.75)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}
              >
                {game.description}
              </p>
            </div>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(to top, rgba(13,27,42,1) 60%, rgba(13,27,42,0) 100%)',
        }}
      >
        {joined ? (
          <div
      ...
      {showConfirmSheet && (
        <>
          ...
          <div
            ...
            style={{ backgroundColor: '#0D1B2A', border: '1px solid rgba(245, 239, 224, 0.1)' }}
          >
            <div
              className="w-12 h-1 rounded-full mx-auto mb-6"
              style={{ backgroundColor: 'rgba(245, 239, 224, 0.2)' }}
            />
            <h3
            ...
            <p
              ...
              style={{ color: 'rgba(245, 239, 224, 0.6)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}
            >
              Your request will be sent to <strong style={{ color: '#F5EFE0' }}>{game.organizerName}</strong> for approval.
            </p>

            <div
              className="p-4 rounded-xl mb-5"
              style={{ backgroundColor: 'rgba(244, 114, 43, 0.08)', border: '1px solid rgba(244, 114, 43, 0.2)' }}
            >
              <p
            ...
            <div className="flex gap-3">
              <button
                className="flex-1 py-4 rounded-2xl font-bold text-sm active:scale-95 transition-transform"
                style={{
              ...
              <button
                className="flex-2 flex-grow py-4 rounded-2xl font-bold text-sm active:scale-95 transition-transform"
                style={{
                  backgroundColor: accentColor,
                  color: '#fff',
                  fontFamily: "'Plus Jakarta Sans', sans-serif",
